...
3. Перейди на вкладку **Interface**
4. В поле **Interface** выбери **Dropdown** (если не выбрано)
5. В разделе **Choices** нажми **+ Add Choice** и добавь каждое значение:
   ```
   Text: Все пользователи     | Value: all
   Text: Премиум              | Value: premium  
   Text: Бесплатные           | Value: free
   ```
6. В поле **Default Value** выбери: `all`
7. В поле **Icon** (опционально) введи: `group`
8. Нажми **Сохранить** (✓ в правом верхнем углу)
